...
const builtInCssClasses: StandardCardCssClasses = {
  ...
  cta1: 'whitespace-nowrap bg-primary-600 text-white font-medium rounded-lg py-2 px-5 shadow',
  cta2: 'whitespace-nowrap bg-white text-primary-600 font-medium rounded-lg py-2 px-5 mt-2 shadow',
