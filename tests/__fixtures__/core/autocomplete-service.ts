...
import { AutocompleteResponse, AutocompleteService, FilterSearchRequest, FilterSearchResponse, UniversalAutocompleteRequest, VerticalAutocompleteRequest } from '@yext/search-headless-react';
