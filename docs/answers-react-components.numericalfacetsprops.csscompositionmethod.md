...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [NumericalFacetsProps](./answers-react-components.numericalfacetsprops.md) &gt; [cssCompositionMethod](./answers-react-components.numericalfacetsprops.csscompositionmethod.md)

## NumericalFacetsProps.cssCompositionMethod property
