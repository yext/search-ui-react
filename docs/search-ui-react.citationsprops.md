...
|  [citationClickHandler?](./search-ui-react.citationsprops.citationclickhandler.md) |  | (data: GenerativeDirectAnswerData) =&gt; void | _(Optional)_ Handle onClick event for citation link. |
