...
```
<b>Extends:</b> StandardFacetProps

## Properties

|  Property | Type | Description |
|  --- | --- | --- |
|  [customCssClasses?](./search-ui-react.numericalfacetprops.customcssclasses.md) | FilterGroupCssClasses &amp; RangeInputCssClasses | <i>(Optional)</i> CSS classes for customizing the component styling. |
