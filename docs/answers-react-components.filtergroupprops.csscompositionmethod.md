...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [FilterGroupProps](./answers-react-components.filtergroupprops.md) &gt; [cssCompositionMethod](./answers-react-components.filtergroupprops.csscompositionmethod.md)

## FilterGroupProps.cssCompositionMethod property
