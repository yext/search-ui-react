...
[GenerativeDirectAnswer({ customCssClasses, answerHeader, hideAISignpost, showFeedbackButtons, aiSignpostProps, citationsHeader, CitationCard, CitationsContainer, }, input)](./search-ui-react.generativedirectanswer.md)
...
[MapboxMap({ mapboxAccessToken, mapboxOptions, keyboardNavigationEnabled, PinComponent, renderPin, getCoordinate, onDrag, iframeWindow, allowUpdates, onPinClick, markerOptionsOverride, }, input)](./search-ui-react.mapboxmap.md)
