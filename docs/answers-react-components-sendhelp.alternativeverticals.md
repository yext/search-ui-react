...
[Home](./index.md) &gt; [@yext/answers-react-components-sendhelp](./answers-react-components-sendhelp.md) &gt; [AlternativeVerticals](./answers-react-components-sendhelp.alternativeverticals.md)
...
|  --- | --- | --- |
|  { currentVerticalLabel, verticalConfigMap, displayAllOnNoResults, customCssClasses, getSuggestionUrl: customGetSuggestionUrl } | [AlternativeVerticalsProps](./answers-react-components-sendhelp.alternativeverticalsprops.md) |  |
