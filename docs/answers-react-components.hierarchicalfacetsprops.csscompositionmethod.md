...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [HierarchicalFacetsProps](./answers-react-components.hierarchicalfacetsprops.md) &gt; [cssCompositionMethod](./answers-react-components.hierarchicalfacetsprops.csscompositionmethod.md)

## HierarchicalFacetsProps.cssCompositionMethod property
