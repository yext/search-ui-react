...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [ResultsCountProps](./answers-react-components.resultscountprops.md) &gt; [cssCompositionMethod](./answers-react-components.resultscountprops.csscompositionmethod.md)

## ResultsCountProps.cssCompositionMethod property
