...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [NumericalFacetsProps](./answers-react-components.numericalfacetsprops.md) &gt; [getFilterDisplayName](./answers-react-components.numericalfacetsprops.getfilterdisplayname.md)
