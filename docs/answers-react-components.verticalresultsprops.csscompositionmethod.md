...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [VerticalResultsProps](./answers-react-components.verticalresultsprops.md) &gt; [cssCompositionMethod](./answers-react-components.verticalresultsprops.csscompositionmethod.md)

## VerticalResultsProps.cssCompositionMethod property
