...
[Home](./index.md) &gt; [@yext/answers-react-components-sendhelp](./answers-react-components-sendhelp.md) &gt; [ApplyFiltersButton](./answers-react-components-sendhelp.applyfiltersbutton.md)
...
|  --- | --- | --- |
|  { customCssClasses, label } | [ApplyFiltersButtonProps](./answers-react-components-sendhelp.applyfiltersbuttonprops.md) |  |
