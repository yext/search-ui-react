...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [PaginationProps](./answers-react-components.paginationprops.md) &gt; [cssCompositionMethod](./answers-react-components.paginationprops.csscompositionmethod.md)

## PaginationProps.cssCompositionMethod property
