...
|  [showFeedbackButtons?](./search-ui-react.standardcardprops.showfeedbackbuttons.md) |  | boolean | _(Optional)_ Whether or not to show thumbs up/down buttons to provide feedback on the result card |
