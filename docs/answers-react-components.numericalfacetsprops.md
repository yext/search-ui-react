...
|  [getFilterDisplayName?](./answers-react-components.numericalfacetsprops.getfilterdisplayname.md) | (numberRange: NumberRangeValue) =&gt; string | <i>(Optional)</i> |
|  [inputPrefix?](./answers-react-components.numericalfacetsprops.inputprefix.md) | JSX.Element | <i>(Optional)</i> |
