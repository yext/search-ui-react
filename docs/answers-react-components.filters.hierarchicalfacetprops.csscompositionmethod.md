...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [Filters](./answers-react-components.filters.md) &gt; [HierarchicalFacetProps](./answers-react-components.filters.hierarchicalfacetprops.md) &gt; [cssCompositionMethod](./answers-react-components.filters.hierarchicalfacetprops.csscompositionmethod.md)

## Filters.HierarchicalFacetProps.cssCompositionMethod property
