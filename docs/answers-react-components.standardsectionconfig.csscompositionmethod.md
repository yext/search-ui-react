...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [StandardSectionConfig](./answers-react-components.standardsectionconfig.md) &gt; [cssCompositionMethod](./answers-react-components.standardsectionconfig.csscompositionmethod.md)

## StandardSectionConfig.cssCompositionMethod property
