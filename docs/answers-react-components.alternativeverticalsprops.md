...
|  [verticalLabelMap](./answers-react-components.alternativeverticalsprops.verticallabelmap.md) | VerticalLabelMap | An array containing the label and verticalKey of each vertical. |
