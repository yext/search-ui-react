...
|  [verticalConfigMap](./answers-react-components.alternativeverticalsprops.verticalconfigmap.md) | Record&lt;string, [VerticalConfig](./answers-react-components.verticalconfig.md)<!-- -->&gt; | An array containing the label and verticalKey of each vertical. |
