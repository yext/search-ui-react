...
|  [verticalLabelMap](./answers-react-components.alternativeverticalsprops.verticallabelmap.md) | [VerticalLabelMap](./answers-react-components.verticallabelmap.md) | An array containing the label and verticalKey of each vertical. |
