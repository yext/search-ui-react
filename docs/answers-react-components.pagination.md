...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [Pagination](./answers-react-components.pagination.md)
...
|  --- | --- | --- |
|  props | [PaginationProps](./answers-react-components.paginationprops.md) |  |
