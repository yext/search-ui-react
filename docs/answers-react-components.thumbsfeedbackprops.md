...
|  --- | --- | --- |
|  [customCssClasses?](./answers-react-components.thumbsfeedbackprops.customcssclasses.md) | [ThumbsFeedbackCssClasses](./answers-react-components.thumbsfeedbackcssclasses.md) | <i>(Optional)</i> CSS classes for customizing the component styling. |
