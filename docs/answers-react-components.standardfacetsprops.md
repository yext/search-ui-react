...
|  [showOptionCounts?](./answers-react-components.standardfacetsprops.showoptioncounts.md) | boolean | <i>(Optional)</i> Whether or not to show the option counts for each filter. Defaults to true. |
