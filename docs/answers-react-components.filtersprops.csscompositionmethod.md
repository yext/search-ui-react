...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [FiltersProps](./answers-react-components.filtersprops.md) &gt; [cssCompositionMethod](./answers-react-components.filtersprops.csscompositionmethod.md)

## FiltersProps.cssCompositionMethod property
