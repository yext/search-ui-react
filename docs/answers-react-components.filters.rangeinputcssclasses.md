...
|  [input\_\_\_invalid?](./answers-react-components.filters.rangeinputcssclasses.input___invalid.md) | string | <i>(Optional)</i> |
|  [input\_\_\_valid?](./answers-react-components.filters.rangeinputcssclasses.input___valid.md) | string | <i>(Optional)</i> |
