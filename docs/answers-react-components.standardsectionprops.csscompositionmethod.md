...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [StandardSectionProps](./answers-react-components.standardsectionprops.md) &gt; [cssCompositionMethod](./answers-react-components.standardsectionprops.csscompositionmethod.md)

## StandardSectionProps.cssCompositionMethod property
