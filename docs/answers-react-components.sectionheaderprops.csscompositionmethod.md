...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [SectionHeaderProps](./answers-react-components.sectionheaderprops.md) &gt; [cssCompositionMethod](./answers-react-components.sectionheaderprops.csscompositionmethod.md)

## SectionHeaderProps.cssCompositionMethod property
