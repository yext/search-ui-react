...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [HierarchicalFacets](./answers-react-components.hierarchicalfacets.md)
...
|  --- | --- | --- |
|  { searchOnChange, collapsible, defaultExpanded, includedFieldIds, customCssClasses, delimiter, showMoreLimit } | [HierarchicalFacetsProps](./answers-react-components.hierarchicalfacetsprops.md) |  |
