...
|  [HierarchicalFacetDisplay({ facet, delimiter, showMoreLimit, customCssClasses, cssCompositionMethod })](./answers-react-components.filters.hierarchicalfacetdisplay.md) | A HierarchicalFacetDisplay takes a <code>DisplayableFacet</code> and renders the facet in a way to represent multiple levels of "hierarchies".<!-- -->The hierarchies are determined by the provided delimiter, which defaults to "<!-- -->&gt;<!-- -->". |
...
|  [HierarchicalFacetDisplayCssClasses](./answers-react-components.filters.hierarchicalfacetdisplaycssclasses.md) | The CSS class interface for [Filters.HierarchicalFacetDisplay()](./answers-react-components.filters.hierarchicalfacetdisplay.md)<!-- -->. |
|  [HierarchicalFacetDisplayProps](./answers-react-components.filters.hierarchicalfacetdisplayprops.md) | Props for [Filters.HierarchicalFacetDisplay()](./answers-react-components.filters.hierarchicalfacetdisplay.md) |
...
|  [StaticFiltersProviderProps](./answers-react-components.filters.staticfiltersproviderprops.md) | Props for the [Filters.StaticFiltersProvider()](./answers-react-components.filters.staticfiltersprovider.md)<!-- -->. |
