...
|  [CollapsibleSection(props)](./answers-react-components.filters.collapsiblesection.md) | CollapsibleSection are used for collapsing and un-collapsing groups of filters. It is intended to be used with a [Filters.CollapsibleLabel()](./answers-react-components.filters.collapsiblelabel.md) within the same [Filters.FilterGroup()](./answers-react-components.filters.filtergroup.md)<!-- -->. |
