...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [StandardFacetsProps](./answers-react-components.standardfacetsprops.md) &gt; [cssCompositionMethod](./answers-react-components.standardfacetsprops.csscompositionmethod.md)

## StandardFacetsProps.cssCompositionMethod property
