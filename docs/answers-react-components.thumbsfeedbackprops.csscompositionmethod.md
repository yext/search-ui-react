...
[Home](./index.md) &gt; [@yext/answers-react-components](./answers-react-components.md) &gt; [ThumbsFeedbackProps](./answers-react-components.thumbsfeedbackprops.md) &gt; [cssCompositionMethod](./answers-react-components.thumbsfeedbackprops.csscompositionmethod.md)

## ThumbsFeedbackProps.cssCompositionMethod property
