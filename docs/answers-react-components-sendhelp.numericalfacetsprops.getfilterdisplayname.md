...
[Home](./index.md) &gt; [@yext/answers-react-components-sendhelp](./answers-react-components-sendhelp.md) &gt; [NumericalFacetsProps](./answers-react-components-sendhelp.numericalfacetsprops.md) &gt; [getFilterDisplayName](./answers-react-components-sendhelp.numericalfacetsprops.getfilterdisplayname.md)
