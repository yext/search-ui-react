...
|  [verticalConfigMap](./answers-react-components.universalresultsprops.verticalconfigmap.md) | VerticalConfigMap | A mapping of verticalKey to the configuration for each vertical. |
